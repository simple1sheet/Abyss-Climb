            ...
            <div className="flex items-end space-x-3">
              <div className="flex-1">
                <Textarea
                  ...
                  className="w-full resize-none bg-abyss-midnight/50 border border-abyss-amber/30 rounded-lg px-4 py-3 text-abyss-ethereal placeholder-abyss-muted focus:outline-none focus:ring-2 focus:ring-abyss-amber/50 focus:border-abyss-amber/50"
                  rows={1}
